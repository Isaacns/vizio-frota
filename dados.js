/* ============================================================
   VIZIO Frota · by VIZIO — Snapshot de dados (modo demonstração)
   ...
   ============================================================ */
const DADOS = {
  _meta: { cliente:"VIZIO Frota — Locacao de Veiculos", versao:"2.0.0", gerado:"2026-07-12", moeda:"BRL" },

  _cfg: {
    produto:"VIZIO", instancia:"VIZIO Frota",
    propLabel:"VIZIO Frota · Locação de Veículos",
    slogan:"A INTELIGÊNCIA POR TRÁS DA FROTA",
