/* ===========================================================================
 * VIZIO Frota by VIZIO — Módulo AGENDA / Pauta do Dia  (padrão §16 + arrastar §15)
 ...
 * do sistema hoje. §16 pede backend com tenant_id + RLS — vale quando o VIZIO Frota
...
var K_EV="viziofrota_agenda_ev_v1", K_TK="viziofrota_agenda_tk_v1", K_LOG="viziofrota_agenda_log_v1", K_PER="viziofrota_agenda_per_v1";
...
function injectCSS(){
  ...
  ".agday.today{border-color:var(--gold);box-shadow:0 0 0 2px rgba(46,107,255,.16)}"+
  ...
  ".agper.cur{background:rgba(46,107,255,.06);border-color:rgba(46,107,255,.26)}"+
  ".agper.drop-ok{outline:2px dashed var(--gold);outline-offset:-2px;background:rgba(46,107,255,.1)}"+
  ...
  ".agev .etk{margin-top:6px;font-size:.62rem;font-weight:700;color:var(--gold);background:rgba(46,107,255,.14);border:0;border-radius:6px;padding:3px 8px;cursor:pointer}"+
  ".agev .etk:hover{background:rgba(46,107,255,.26)}"+
  ...
  ".agcol.drop-ok{outline:2px dashed var(--gold);outline-offset:-4px;background:rgba(46,107,255,.08)}"+
  ...
  ".agfocus{display:flex;align-items:center;gap:8px;font-size:.82rem;color:var(--sec);background:rgba(46,107,255,.07);border:1px solid rgba(46,107,255,.22);border-radius:10px;padding:9px 13px;margin-bottom:12px}"+
  ".agnav{display:flex;align-items:center;gap:8px;flex-wrap:wrap}"+
  ".aghint{font-size:.73rem;color:var(--mut-2);margin:2px 0 10px}"+
  ".agdrop{position:fixed;left:0;right:0;bottom:0;z-index:9999;display:flex;gap:10px;padding:12px 16px 14px;background:rgba(10,15,30,.94);backdrop-filter:blur(10px);box-shadow:0 -10px 34px rgba(0,0,0,.5)}"+
...
function rAgenda(v){
  ...
  var fim=new Date(base);fim.setDate(base.getDate()+6);
